package com.nclab.chl848.t3android.Network;
...
public class BLEHandler {
    ...
    public static final String BLE_CONNECTION_UPDATE_ACTION = "t3.chl848.nclab.com.BLE_CONNECTION_UPDATE_ACTION";
    public static final String BLE_CONNECTION_AUTO_STOP_SCAN_ACTION = "t3.chl848.nclab.com.BLE_CONNECTION_AUTO_STOP_SCAN_ACTION";
    public static final String BLE_CONNECTION_NOT_SUPPORT_ACTION = "t3.chl848.nclab.com.BLE_CONNECTION_NOT_SUPPORT_ACTION";
    public static final String BLE_CONNECTION_CENTRAL_FOUND_PERIPH_ACTION = "t3.chl848.nclab.com.BLE_CONNECTION_CENTRAL_FOUND_PERIPH_ACTION";
    public static final String BLE_CONNECTION_PERIPHL_FOUND_CENTRAL_ACTION = "t3.chl848.nclab.com.BLE_CONNECTION_PERIPHL_FOUND_CENTRAL_ACTION";
    public static final String BLE_CONNECTION_BT_DISABLE_ACTION = "t3.chl848.nclab.com.BLE_CONNECTION_BT_DISABLE_ACTION";

    public final static String BLE_GATT_CONNECTED_ACTION = "t3.chl848.nclab.com.le.ACTION_GATT_CONNECTED";
    public final static String BLE_GATT_DISCONNECTED_ACTION = "t3.chl848.nclab.com.ACTION_GATT_DISCONNECTED";
    public final static String BLE_GATT_SERVICES_DISCOVERED_ACTION = "t3.chl848.nclab.com.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String BLE_RECEIVED_DATA_ACTION = "t3.chl848.nclab.com.BLE_RECEIVED_DATA_ACTION";
    public final static String BLE_EXTRA_DATA_RECEIVE_TIME = "t3.chl848.nclab.com.BLE_EXTRA_DATA_RECEIVE_TIME";
    public final static String BLE_EXTRA_DATA = "t3.chl848.nclab.com.EXTRA_DATA";
    public final static String BLE_EXTRA_DATA_ADDRESS = "t3.chl848.nclab.com.BLE_EXTRA_DATA_ADDRESS";

    private static final long SCAN_PERIOD = 30000;
    public static final String TRANSFER_SERVICE_UUID = "7CFA5442-3C3E-4522-902C-B347C1957515";
    public static final String TRANSFER_CHARACTERISTIC_MSG_FROM_PERIPHERAL_UUID = "446EF5DD-3E31-40DA-897F-22C31065C861";
    public static final String TRANSFER_CHARACTERISTIC_MSG_FROM_CENTRAL_UUID = "88376596-5F9F-4923-A30C-D17044687B53";
    ...
    public void setup() {
        ...
        if (m_bluetoothAdapter != null && m_bluetoothAdapter.isEnabled()) {
            m_bluetoothAdapter.setName(m_localName);
            if (isCentral()) {
                initCentral();
            ...
            broadcastStatus(BLE_CONNECTION_BT_DISABLE_ACTION);
        }
    }
    ...
    private void broadcastStatus(String action, String msg, String address) {
        Intent i = new Intent(action);
        i.putExtra(BLE_EXTRA_DATA, msg);
        i.putExtra(BLE_EXTRA_DATA_ADDRESS, address);
        m_currentActivity.sendBroadcast(i);
    }
            ...
            public void onScanResult(int callbackType, ScanResult result) {
                ...
                try {
                    ...
                    if (isFound) {
                        ...
                        broadcastStatus(BLE_CONNECTION_CENTRAL_FOUND_PERIPH_ACTION, device.getName(), device.getAddress());
    ...
    public void connectToPeripheral(String deviceAddress) {
        PeripheralInfo info = m_peripheralDevices.get(deviceAddress);
        if (info != null) {
            connectToPeripheral(info.m_device, info);
        }
    }
    ...
    public boolean sendDataToPeripheral(String address, byte[] msg) {
        ...
        if (info != null) {
            ...
            Log.d(TAG, "sendDataToPeripheral: byteMsg size : " + msg.length + ", to : " + info.m_device.getName() +  ", result : " + rt);
        }
